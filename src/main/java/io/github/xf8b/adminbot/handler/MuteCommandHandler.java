...
@CommandHandler(
        ...
        description = "Mutes the specified user for the specified amount of time."
)
public class MuteCommandHandler {
    public static void onMuteCommand(MessageReceivedEvent event) throws SQLException, ClassNotFoundException {
