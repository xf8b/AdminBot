...
@CommandHandler(
        ...
        aliases = {"${prefix}warnings"}
)
public class WarnsCommandHandler {
    public static void onWarnsCommand(MessageReceivedEvent event) throws SQLException, ClassNotFoundException {
